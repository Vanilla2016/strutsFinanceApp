...
public class AccountAggregatorActionTest extends StrutsTestCase {
    ...
    public void testAccountAggregatorAction() throws Exception {
        ...
        String result = accountAggregatorAction.execute();
        assertEquals("Expected a success result!", ActionSupport.SUCCESS, result);
        assertEquals("Expected the default message!", accountAggregatorAction.getText(AccountAggregatorAction.MESSAGE), accountAggregatorAction.getMessage());
    }
